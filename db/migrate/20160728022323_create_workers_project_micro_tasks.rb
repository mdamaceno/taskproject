class CreateWorkersProjectMicroTasks < ActiveRecord::Migration[5.0]
  def change
    ...
    add_foreign_key :workers_project_micro_tasks, :workers, column: :worker_id
    add_foreign_key :workers_project_micro_tasks, :project_micro_tasks, column: :micro_task_id
    add_index :workers_project_micro_tasks, :worker_id
    add_index :workers_project_micro_tasks, :micro_task_id
  end
end
