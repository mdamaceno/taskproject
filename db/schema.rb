...
ActiveRecord::Schema.define(version: 20160728022323) do
  ...
  create_table "break_points", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    t.uuid     "worker_id"
    t.uuid     "micro_task_id"
    t.integer  "opened",        default: 0, null: false
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
    t.index ["micro_task_id"], name: "index_break_points_on_micro_task_id", using: :btree
    t.index ["worker_id"], name: "index_break_points_on_worker_id", using: :btree
  end
